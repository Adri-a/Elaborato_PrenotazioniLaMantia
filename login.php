...
<head>
    ...
    <title>LaMantia - Registrazione</title>
    ...
    <main id="main">
        ...
        <section id="book-a-table" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <form action="forms/loggato.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="sent-message">Sei entrato</div>
                    </div>
                    <div class="text-center"><button type="submit">Entra</button></div>
                </form>
